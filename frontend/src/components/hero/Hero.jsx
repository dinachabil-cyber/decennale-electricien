      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="w-full lg:flex-1 order-1 lg:order-2">
            <div className="bg-surface rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl p-6 md:p-8 lg:p-10 card-hover border border-gray-100">
              ...
              {success ? (
                <div className="text-center py-8 md:py-12">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-success rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
                ...
                <form id="contactForm" onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  {error && (
                    <div className="bg-red-50 border border-red-300 text-red-700 px-4 py-3 rounded-lg text-sm md:text-base">
                      {error}
                    </div>
                  )}
                  ...
                  <div className="space-y-4 md:space-y-6">
                    <div className="form-group">
                      <div className="input-group flex">
                        <span className="inline-flex items-center px-3 py-3 md:px-4 md:py-4 bg-gray-50 border border-r-0 border-gray-200 rounded-l-xl text-gray-600">
                          <i className="fas fa-building text-yellow-500 text-sm md:text-base"></i>
                        </span>
                        <input
                          type="text"
                          name="entreprise"
                          ...
                          className="flex-1 px-3 md:px-4 py-3 md:py-4 border border-gray-200 rounded-r-xl bg-light focus:bg-surface focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all duration-300 form-input text-sm md:text-base"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="form-group">
                        <div className="input-group flex">
                          <span className="inline-flex items-center px-3 py-3 md:px-4 md:py-4 bg-gray-50 border border-r-0 border-gray-200 rounded-l-xl text-gray-600">
                            <i className="fas fa-user text-yellow-500 text-sm md:text-base"></i>
                          </span>
                          <input
                            type="text"
                            name="nom"
                      ...
                      <div className="form-group">
                        <div className="input-group flex">
                          <span className="inline-flex items-center px-3 py-3 md:px-4 md:py-4 bg-gray-50 border border-r-0 border-gray-200 rounded-l-xl text-gray-600">
                            <i className="fas fa-briefcase text-yellow-500 text-sm md:text-base"></i>
                          </span>
                          <select
                            name="statut"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="form-group">
                        <div className="input-group flex">
                          <span className="inline-flex items-center px-3 py-3 md:px-4 md:py-4 bg-gray-50 border border-r-0 border-gray-200 rounded-l-xl text-gray-600">
                            <i className="fas fa-phone text-yellow-500 text-sm md:text-base"></i>
                          </span>
                          <input
                            type="tel"
                            name="tele"
                      ...
                      <div className="form-group">
                        <div className="input-group flex">
                          <span className="inline-flex items-center px-3 py-3 md:px-4 md:py-4 bg-gray-50 border border-r-0 border-gray-200 rounded-l-xl text-gray-600">
                            <i className="fas fa-envelope text-yellow-500 text-sm md:text-base"></i>
                          </span>
                          <input
                            type="email"
                            name="email"
                    ...
                    <div className="form-group">
                      <div className="input-group flex">
                        <span className="inline-flex items-center px-3 py-3 md:px-4 md:py-4 bg-gray-50 border border-r-0 border-gray-200 rounded-l-xl text-gray-600">
                          <i className="fas fa-euro-sign text-yellow-500 text-sm md:text-base"></i>
                        </span>
                        <select
                    ...
                    <div className="flex items-start space-x-3 p-4 md:p-6 bg-yellow-50 rounded-xl md:rounded-2xl border border-yellow-200">
                      <input
                        type="checkbox"
                        defaultChecked
                        className="mt-0.5 w-4 h-4 md:w-5 md:h-5 text-yellow-500 rounded focus:ring-2 focus:ring-yellow-500 border-2 border-yellow-300"
                      />
                    ...
                    <div className="flex justify-center">
                      <button
                        type="submit"
                        disabled={loading}
                        className="btn-modern w-full bg-gradient-to-r from-yellow-400 to-yellow-500 text-dark font-bold py-4 px-8 rounded-xl pulse-animation hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2"
                      >
                        {loading ? (
                          <>
          ...
          <div className="w-full lg:flex-1 order-2 lg:order-1">
            <div className="w-full lg:h-[500px]">
              <div className="w-full h-48 md:h-56 lg:h-full bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl overflow-hidden">
